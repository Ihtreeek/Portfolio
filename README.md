...
This is my personal portfolio website built with React.js and Tailwindcss, showcasing my skills and projects. The website is designed and created entirely by me, Sabbisetti Keerthi.
...
1. Clone this repository to your local machine:
   ```
   git clone https://github.com/Ihtreeek/Portfolio.git
   ```
...
You can reach out to me via email at [sabbisettikeerthi@gmial.com](mailto:sabbisettikeerthi@gmail.com) or connect with me on [LinkedIn](https://www.linkedin.com/in/sabbisettikeerthi/).
